...
const translations = {
  zh: {
    ...
    setupNameTitle: '设备名称',
    setupNameDesc: '输入一个稳定、好认的名称，系统会自动拼接最终别名。',
  ...
  en: {
    ...
    setupNameDesc: 'Pick a stable, readable name. RoboClaw will build the final alias from it.',
